...
describe("AddItemForm components Component Tests - Logged in", () => {
  ...
  it("call fn on click", () => {
    ...
    const wrapper = shallow(
      <button type="submit" className="submitForm" onClick={handleClick}>
        Submit
      </button>
    );
  ...
  it("call fn change", () => {
    ...
    wrapper
      .find("input")
      .simulate("change", { target: { value: "2022/02/11" } });
    wrapper.simulate("change");
    expect(handleChange).toHaveBeenCalled();
  });
  it("All the button called fn", () => {
    ...
    const wrapper = shallow(
      <div className="buttonForm">
        <button type="button" className="isMonday" onClick={handleClick}>
          {" "}
          Monday{" "}
        </button>
        <button type="button" className="isTuesday" onClick={handleClick}>
          {" "}
          Tuesday{" "}
        </button>
        <button type="button" className="isWednesday" onClick={handleClick}>
          {" "}
          Wednesday{" "}
        </button>
        <button type="button" className="isThursday" onClick={handleClick}>
          {" "}
          Thursday{" "}
        </button>
        <button type="button" className="isFriday" onClick={handleClick}>
          {" "}
          Friday{" "}
        </button>
        <button type="button" className="isSaturday" onClick={handleClick}>
          {" "}
          Saturday{" "}
        </button>
        <button type="button" className="isSunday" onClick={handleClick}>
          {" "}
          Sunday{" "}
        </button>
      </div>
  ...
  it("Priority will change when click", () => {
    ...
    wrapper
      .find("button")
      .at(0)
      .simulate("click", { target: { id: "high" } });
    wrapper
      .find("button")
      .at(1)
      .simulate("click", { target: { id: "medium" } });
    wrapper
      .find("button")
      .at(2)
      .simulate("click", { target: { id: "low" } });
    expect(handleClick).toHaveBeenCalled();
  });
});
